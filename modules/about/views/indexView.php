...
<div class="container mt-5">
  ...
  <div class="row mt-5 mb-5">
    <?php foreach ($list_about as $item) { ?>
      <!-- Hình ảnh bên trái -->
      <div class="col-md-4 ">
        <img src="public/images/<?php echo $item['url_image'] ?>" alt="Hình ảnh" class="img-fluid img-about">
      </div>

      <!-- Thông tin bên phải -->
      <div class="col-md-8 ">
        <h2><?php echo $item['about_title'] ?></h2>
        <p class="text-about"><?php echo $item['about_content'] ?></p>
